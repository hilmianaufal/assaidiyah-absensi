<div>
    ...
    <div class="space-y-6">
            ...
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5">
                <div>
                    ...
                    <p class="text-blue-50 mt-2">
                        Honor paket, transport, tambahan honor, potongan alpa, dan pembayaran.
                    </p>
                </div>
        ...
        <section class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-5 gap-4">
            ...
            <div class="bg-white rounded-3xl p-5 shadow-sm border border-slate-100">
                <p class="text-sm text-slate-500">Tambahan Honor</p>
        ...
        <section class="grid gap-4">
            @forelse ($honors as $honor)
                @php
                    ...
                    $remaining = max($honor->grand_total - $paidTotal, 0);
                @endphp
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 xl:grid-cols-7 gap-3 mt-5">
                        ...
                        <div class="rounded-2xl bg-blue-50 p-4">
                            ...
                            <p class="font-black text-blue-700">
                                Rp{{ number_format($honor->total_teaching_honor, 0, ',', '.') }}
                            </p>
                        </div>
                        ...
                        <div class="rounded-2xl bg-slate-50 p-4">
                            ...
                            <p class="font-black text-slate-900">
                                Rp{{ number_format($honor->total_transport, 0, ',', '.') }}
                            </p>
                        </div>
                        ...
                        <div class="bg-white rounded-3xl p-5 shadow-sm border border-slate-100">
                            <p class="text-sm text-slate-500">Sisa Pembayaran</p>
